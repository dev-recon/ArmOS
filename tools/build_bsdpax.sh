...
WORK_DIR="${WORK_DIR:-$ROOT_DIR/build/${TARGET_ARCH:-arm32}/${TARGET_PLATFORM:-qemu-virt}/bundles/bsdpax}"
...
echo "  ln -sfn ../../opt/bsdpax/bin/pax $USERFS_ROOT/usr/bin/pax"
echo "  ln -sfn ../../opt/bsdpax/bin/tar $USERFS_ROOT/usr/bin/tar"
