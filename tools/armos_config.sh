...
BUILD_NEWLIB BUILD_ALL_USERLAND BUILD_TCC BUILD_BSD BUILD_NCURSES BUILD_NANO BUILD_EPOLL_SHIM BUILD_PIXMAN BUILD_TLLIST BUILD_UTF8PROC BUILD_FREETYPE BUILD_EXPAT BUILD_FONTCONFIG BUILD_HARFBUZZ BUILD_FCFT BUILD_FOOT BUILD_NUKLEAR BUILD_MESA BUILD_RAYLIB
