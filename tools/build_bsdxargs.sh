...
WORK_DIR="${WORK_DIR:-$ROOT_DIR/build/${TARGET_ARCH:-arm32}/${TARGET_PLATFORM:-qemu-virt}/bundles/bsdxargs}"
...
echo "  ln -sfn ../../opt/bsdxargs/bin/xargs $USERFS_ROOT/usr/bin/xargs"
