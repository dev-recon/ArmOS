 ...
 *
 * Bicubic Bezier control points supplied for the Utah teapot demo.
 */

#ifndef ARMOS_TEAPOT_MODEL_H
#define ARMOS_TEAPOT_MODEL_H

static const float teapot_patches[][16][3] = {
{ // 0
...
#define TEAPOT_PATCH_COUNT \
    (sizeof(teapot_patches) / sizeof(teapot_patches[0]))
