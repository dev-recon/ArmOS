...
static const char wl_xkb_keymap[] =
    ...
    "  key <ESC> { [ Escape ] }; key <AE01> { [ ampersand, 1 ] };\n"
    "  key <AE02> { [ eacute, 2 ] }; key <AE03> { [ quotedbl, 3 ] };\n"
    "  key <AE04> { [ apostrophe, 4 ] }; key <AE05> { [ parenleft, 5 ] };\n"
    "  key <AE06> { [ section, 6 ] }; key <AE07> { [ egrave, 7 ] };\n"
    "  key <AE08> { [ exclam, 8 ] }; key <AE09> { [ ccedilla, 9 ] };\n"
    "  key <AE10> { [ agrave, 0 ] }; key <AE11> { [ parenright, degree ] };\n"
    "  key <AE12> { [ minus, underscore ] }; key <BKSP> { [ BackSpace ] };\n"
    "  key <TAB> { [ Tab ] }; key <AD01> { [ a, A ] };\n"
    "  key <AD02> { [ z, Z ] }; key <AD03> { [ e, E ] };\n"
    "  key <AD04> { [ r, R ] }; key <AD05> { [ t, T ] };\n"
    "  key <AD06> { [ y, Y ] }; key <AD07> { [ u, U ] };\n"
    "  key <AD08> { [ i, I ] }; key <AD09> { [ o, O ] };\n"
    "  key <AD10> { [ p, P ] }; key <AD11> { [ bracketleft, braceleft ] };\n"
    "  key <AD12> { [ dollar, asterisk ] }; key <RTRN> { [ Return ] };\n"
    "  key <LCTL> { [ Control_L ] }; key <AC01> { [ q, Q ] };\n"
    "  key <AC02> { [ s, S ] }; key <AC03> { [ d, D ] };\n"
    "  key <AC04> { [ f, F ] }; key <AC05> { [ g, G ] };\n"
    "  key <AC06> { [ h, H ] }; key <AC07> { [ j, J ] };\n"
    "  key <AC08> { [ k, K ] }; key <AC09> { [ l, L ] };\n"
    "  key <AC10> { [ m, M ] }; key <AC11> { [ ugrave, percent ] };\n"
    "  key <TLDE> { [ less, greater ] }; key <LFSH> { [ Shift_L ] };\n"
    "  key <BKSL> { [ grave ] }; key <AB01> { [ w, W ] };\n"
    "  key <AB02> { [ x, X ] }; key <AB03> { [ c, C ] };\n"
    "  key <AB04> { [ v, V ] }; key <AB05> { [ b, B ] };\n"
    "  key <AB06> { [ n, N ] }; key <AB07> { [ comma, question ] };\n"
    "  key <AB08> { [ semicolon, period ] }; key <AB09> { [ colon, slash ] };\n"
    "  key <AB10> { [ equal, plus ] }; key <RTSH> { [ Shift_R ] };\n"
