...
static syscall_func_t syscall_table[MAX_SYSCALLS] = {
    ...
    [__NR_sendmsg] = (syscall_func_t)sys_sendmsg,
    [__NR_recvmsg] = (syscall_func_t)sys_recvmsg,
    ...
    [__NR_eventfd2] = (syscall_func_t)sys_eventfd2,
    [__NR_timerfd_create] = (syscall_func_t)sys_timerfd_create,
    [__NR_timerfd_settime] = (syscall_func_t)sys_timerfd_settime,
    [__NR_timerfd_gettime] = (syscall_func_t)sys_timerfd_gettime,
